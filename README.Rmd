...
It reports three statistics—the median estimate, the share of specifications significant in the predicted direction, and a Stouffer combination of the per-specification *p*-values—each with its own permutation *p*-value:
...
Feel free to contact me at [zayne@mit.edu](mailto:zayne@mit.edu) to let me know of features you would find useful. Currently, I hope to add the following:

* A formal joint-inference test for the specification curve (à la Simonsohn, Simmons, and Nelson 2020), comparing the observed curve to its distribution under the null
